...
- The ten rules are what 22 open-source projects converge on, filtered for what fits a team of seventeen people who see each other daily.
- Three findings are consistent across the evidence: developers overestimate their own speed-up, review load grows faster than throughput, and unreviewed model output fails security tests about 45% of the time.
- Digdir's own guidance already asks for disclosure in the PR and for keeping secrets and test data out of tool context. For a coding assistant, the AI Act adds a duty to support AI literacy and nothing more.
- Where a number or a line had to be chosen (400 lines, what to disclose, what counts as generated), section 4 shows the alternative and why.
- The rules themselves are in CONTRIBUTING.md. Sections 1 to 3 are background for those who want it.
...
**Digitaliseringsrundskrivet D-2/25** (May 2025) is binding for state bodies, but its AI section 1.3 is a recommendation, not a requirement: state bodies *should* assess where AI helps, *should* have a plan, and *should* make sure employees know the organisation's routines for AI. It says nothing specific about coding assistants, and its section 1.8 concerns web analytics on public websites, not AI tools. Whether a data protection impact assessment is needed for a given tool depends on the processing and its likely risk, under GDPR article 35 as Datatilsynet explains it; that assessment is part of #4083. This agreement and rule 9 on onboarding follow the recommendation in 1.3.
...
- Regjeringen, *Digitaliseringsrundskrivet* D-2/25 (2025-05): <https://www.regjeringen.no/no/dokumenter/digitaliseringsrundskrivet/id3103320/>
- Datatilsynet, *Risiko og risikovurdering* (when a DPIA is required under GDPR article 35): <https://www.datatilsynet.no/rettigheter-og-plikter/virksomhetenes-plikter/vurdering-av-personvernkonsekvenser/risikovurdering/>
