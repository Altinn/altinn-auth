...
public static partial class StaticDataIngest
{
    ...
    public async static Task IngestRolePackage(AppDbContext dbContext, CancellationToken cancellationToken = default)
    {
        ...
        var data = new List<RolePackage>()
        {
            ...
            new RolePackage() { RoleId = roleInnh, PackageId = PackageConstants.InstanceDelegation.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtso, PackageId = PackageConstants.InstanceDelegation.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtpr, PackageId = PackageConstants.InstanceDelegation.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleKomp, PackageId = PackageConstants.InstanceDelegation.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleBest, PackageId = PackageConstants.InstanceDelegation.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            ...
            new RolePackage() { RoleId = roleInnh, PackageId = PackageConstants.RegistrationTransferOfVehicles.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtso, PackageId = PackageConstants.RegistrationTransferOfVehicles.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtpr, PackageId = PackageConstants.RegistrationTransferOfVehicles.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleKomp, PackageId = PackageConstants.RegistrationTransferOfVehicles.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            ...
            new RolePackage() { RoleId = roleInnh, PackageId = PackageConstants.FirstTimeVehicleRegistration.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtso, PackageId = PackageConstants.FirstTimeVehicleRegistration.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtpr, PackageId = PackageConstants.FirstTimeVehicleRegistration.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleKomp, PackageId = PackageConstants.FirstTimeVehicleRegistration.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            ...
            new RolePackage() { RoleId = roleDagl, PackageId = PackageConstants.VATCompensationAuditorCertifies.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleLede, PackageId = PackageConstants.VATCompensationAuditorCertifies.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleInnh, PackageId = PackageConstants.VATCompensationAuditorCertifies.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtso, PackageId = PackageConstants.VATCompensationAuditorCertifies.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtpr, PackageId = PackageConstants.VATCompensationAuditorCertifies.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            ...
            new RolePackage() { RoleId = roleInnh, PackageId = PackageConstants.Revision.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtso, PackageId = PackageConstants.Revision.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtpr, PackageId = PackageConstants.Revision.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleKomp, PackageId = PackageConstants.Revision.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            ...
            new RolePackage() { RoleId = roleInnh, PackageId = PackageConstants.TrainingOfficeLeader.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtso, PackageId = PackageConstants.TrainingOfficeLeader.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtpr, PackageId = PackageConstants.TrainingOfficeLeader.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            ...
            new RolePackage() { RoleId = roleInnh, PackageId = PackageConstants.RepairInstallationMachineryAndEquipment.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtso, PackageId = PackageConstants.RepairInstallationMachineryAndEquipment.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtpr, PackageId = PackageConstants.RepairInstallationMachineryAndEquipment.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleKomp, PackageId = PackageConstants.RepairInstallationMachineryAndEquipment.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            ...
            new RolePackage() { RoleId = roleInnh, PackageId = PackageConstants.TechnicalInteractionWithDigdir.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtso, PackageId = PackageConstants.TechnicalInteractionWithDigdir.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtpr, PackageId = PackageConstants.TechnicalInteractionWithDigdir.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleKomp, PackageId = PackageConstants.TechnicalInteractionWithDigdir.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            ...
            new RolePackage() { RoleId = roleInnh, PackageId = PackageConstants.OppgiNaermesteLeder.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtso, PackageId = PackageConstants.OppgiNaermesteLeder.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleDtpr, PackageId = PackageConstants.OppgiNaermesteLeder.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleKomp, PackageId = PackageConstants.OppgiNaermesteLeder.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roleBest, PackageId = PackageConstants.OppgiNaermesteLeder.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            ...
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerTilgangsstyringPrivatperson.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerPermisjonOppsigelse.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerArbeidsliv.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerPensjon.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerUtdanning.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerSykefravaer.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerSoknaderSertifisering.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerBarnForeldre.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerBarnehageSfoSkole.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerSamliv.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerFritidsaktiviteterFriluftsliv.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerAvlastningStotte.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerBehandling.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerHelsetjenester.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerPleieOmsorg.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerKultur.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerIdrett.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerFrivillighet.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerPatent.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerSertifisering.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerAttester.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerDesignVaremerke.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerStraffesak.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerVapen.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerByggesoknad.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerBoligEiendom.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerLoyve.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerKjoretoy.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerForerkort.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerBankFinans.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerForsikring.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = rolePriv, PackageId = PackageConstants.InnbyggerSkatteforholdPrivatpersoner.Id, EntityVariantId = null, CanDelegate = true, HasAccess = true },
            ...
            new RolePackage() { RoleId = RoleConstants.InsuranceCompanyManagingInsuranceAgreements, PackageId = PackageConstants.VergemalInsuranceCompanyManagingInsuranceAgreements.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.HelfoReimbursementForPrivateIndividuals, PackageId = PackageConstants.VergemalHelfoReimbursementForPrivateIndividuals.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.HelfoGeneralPractitioner, PackageId = PackageConstants.VergemalHelfoGeneralPractitioner.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheHousingBankHousingAllowance, PackageId = PackageConstants.VergemalTheHousingBankHousingAllowance.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheHousingBankStartupLoan, PackageId = PackageConstants.VergemalTheHousingBankStartupLoan.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.DebtCollectionCompaniesNegotiateAndConcludeDebtCollectionAgreements, PackageId = PackageConstants.VergemalDebtCollectionCompaniesNegotiateAndConcludeDebtCollectionAgreements.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheNorwegianMappingAuthoritySaleOfRealEstatecondominiumShare, PackageId = PackageConstants.VergemalTheNorwegianMappingAuthoritySaleOfRealEstatecondominiumShare.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheNorwegianMappingAuthorityPurchaseOfProperty, PackageId = PackageConstants.VergemalTheNorwegianMappingAuthorityPurchaseOfProperty.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheNorwegianMappingAuthorityInheritancePrivateSettlementAndUndividedEstate, PackageId = PackageConstants.VergemalTheNorwegianMappingAuthorityInheritancePrivateSettlementAndUndividedEstate.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheNorwegianMappingAuthorityChangeOfProperty, PackageId = PackageConstants.VergemalTheNorwegianMappingAuthorityChangeOfProperty.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheNorwegianMappingAuthorityAgreementsAndRights, PackageId = PackageConstants.VergemalTheNorwegianMappingAuthorityAgreementsAndRights.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheNorwegianMappingAuthorityDeletion, PackageId = PackageConstants.VergemalTheNorwegianMappingAuthorityDeletion.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheNorwegianMappingAuthorityLoanAcquisition, PackageId = PackageConstants.VergemalTheNorwegianMappingAuthorityLoanAcquisition.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.MunicipalityBuildingAndProperty, PackageId = PackageConstants.VergemalMunicipalityBuildingAndProperty.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.MunicipalityHealthAndCare, PackageId = PackageConstants.VergemalMunicipalityHealthAndCare.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.MunicipalityTaxAndDuty, PackageId = PackageConstants.VergemalMunicipalityTaxAndDuty.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.MunicipalitySocialServices, PackageId = PackageConstants.VergemalMunicipalitySocialServices.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.MunicipalitySchoolAndEducation, PackageId = PackageConstants.VergemalMunicipalitySchoolAndEducation.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.CreditRatingAgencyCreditFreeze, PackageId = PackageConstants.VergemalCreditRatingAgencyCreditFreeze.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheEnforcementOfficerDebtSettlement, PackageId = PackageConstants.VergemalTheEnforcementOfficerDebtSettlement.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.EnforcementIncludingProceedingsInTheConciliationBoard, PackageId = PackageConstants.VergemalEnforcementIncludingProceedingsInTheConciliationBoard.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.NavWork, PackageId = PackageConstants.VergemalNavWork.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.NavFamily, PackageId = PackageConstants.VergemalNavFamily.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.NavAssistiveDevices, PackageId = PackageConstants.VergemalNavAssistiveDevices.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.NavPension, PackageId = PackageConstants.VergemalNavPension.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.NavSocialServices, PackageId = PackageConstants.VergemalNavSocialServices.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.PatientTravelReimbursementOfPatientTravel, PackageId = PackageConstants.VergemalPatientTravelReimbursementOfPatientTravel.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheTaxAdministrationChangePostalAddress, PackageId = PackageConstants.VergemalTheTaxAdministrationChangePostalAddress.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheTaxAdministrationReportMoving, PackageId = PackageConstants.VergemalTheTaxAdministrationReportMoving.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheTaxAdministrationTax, PackageId = PackageConstants.VergemalTheTaxAdministrationTax.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheTaxAdministrationCollectionAndEnforcement, PackageId = PackageConstants.VergemalTheTaxAdministrationCollectionAndEnforcement.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.CountyGovernorApplyForConsentToDisposition, PackageId = PackageConstants.VergemalCountyGovernorApplyForConsentToDisposition.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheDistrictCourtPetitionForUndividedEstate, PackageId = PackageConstants.VergemalTheDistrictCourtPetitionForUndividedEstate.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheDistrictCourtPrivateSettlementOfEstate, PackageId = PackageConstants.VergemalTheDistrictCourtPrivateSettlementOfEstate.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.TheDistrictCourtPetitionForSettlementOfUndividedEstate, PackageId = PackageConstants.VergemalTheDistrictCourtPetitionForSettlementOfUndividedEstate.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.OthersPurchaserentalOfGoodsAndServices, PackageId = PackageConstants.VergemalOthersPurchaserentalOfGoodsAndServices.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            new RolePackage() { RoleId = RoleConstants.OthersConclusionOfLeaseAgreements, PackageId = PackageConstants.VergemalOthersConclusionOfLeaseAgreements.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
